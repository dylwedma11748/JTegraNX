...
public class Updater {
    ...
    private final String currentVersion = "v1.5";
                        ...
                        if (currentVersionFloat < latestVersionFloat) {
                            ...
                            if (updaterDialog.getResult().toString().equals("ButtonType [text=Download, buttonData=OK_DONE]")) {
                                ...
                                if (file != null) {
                                    ...
                                    Downloader.downloadFile(downloadURL, filePath, false, false);
                                } else {
                            ...
                            JTegraNX.getController().appendLog("JTegraNX is up to date.");
                            break;
                        }
